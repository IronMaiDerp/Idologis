...
<html>
	...
	<body>
		...
		<form action="./ConfirmLocation.php" enctype="multipart/form-data" method="POST">
			<div class="conteneur">
				<h3>Liste des locations</h3>
				<b>* = Champ obligatoire</b> </br> </br>
					<label>Réference * </label>
						<input name="reference" autofocus="" required=""></br> </br>
					<label>Type *</label>
					...
					<label>Loyer *</label>
						<input name="loyer" type="number" autofocus=""  required=""><em>/mois</em></br> </br>
			</div>
