	...
	<body>
		...
		<form  action="../locations.php" method="POST">
			...
			<?php
				...
				$donnees = "<tr>". "<td>".$_POST['reference']."</td>" . "<td>".$_POST['type']."</td>" . "<td>".$_POST['secteur']."</td>" . "<td>".$_POST['surface']."</td>". "<td>".$_POST['loyer']."</td>". "<td>" ."<a  class=".'"couleur"'." href=".'./Locations/'.$_POST['reference'].".php".">voir</a>"."</td>". "</tr>";
...
<html>
	...
	<body>
		...
		<div class="conteneur">
			<h1>Bien n°'.$reference.' : '.$loyer.' € / mois</h1>
			
			<h2>Photo</h2>
			<p class="centre"><img src="../Locations/photos/'.$reference.".".$extension.'" alt="Bien n°'.$reference.'" class="bien"/></p>
			...
			<p class="centre"><a class="couleur" href="../locations.php">Retour à la liste des locations</a></p>
		</div>
		...
		<footer>
				...
				$photo="../Locations/photos/".$reference.".".$extension;
				$prepareVente=$db->prepare('INSERT INTO LOCATION VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
				$prepareVente->execute(array($reference, $bien, $photo, $secteur, $surface, $Loyer, $surfaceT, $chambre, $piece, $type, $personelDedie, $classe, $mail, $plus, $lien));

				$fileOpen = fopen ("../Locations/".$_POST['reference'].".php", 'a+');
