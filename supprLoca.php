...
echo '<a href="locations.php?Reference='.$_GET['Reference'].'&param=suppr"><input type="submit" name="Oui" value="Oui" /></a>';
echo '<a href="locations.php"><input type="submit" name="Non" value="Non" /></a>';
}
?>
